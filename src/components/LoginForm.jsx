...
const LoginForm = () => {
  ...
  return (
    <div className="min-h-screen bg-cover bg-center flex flex-row items-center justify-center" style={{ backgroundImage: `url(${fondo_login})` }}>
      <div className="max-w-md mx-auto mt-8 p-6 rounded-t-lg bg-white">
        <form className="bg-white rounded px-8 pt-6 pb-8 mb-4 w-full max-w-sm md:mt-8" onSubmit={handleSubmit}>
