...
const LoginForm = () => {
  ...
  return (
    <div className="bg-no-repeat min-h-screen max-h-screen bg-[top_-8rem_right_-8rem] bg-auto xs:bg-cover xs:bg-center flex flex-row items-center justify-center" style={{ backgroundImage: `url(${fondo_login})` }}>
